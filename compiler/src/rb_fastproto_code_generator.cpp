...
namespace rb_fastproto {
    ...
    void RBFastProtoCodeGenerator::write_cpp_message_struct_allocators(
        ...
        printer.Print(
            ...
            "        auto key_iterator = [](VALUE block_arg, VALUE _self, int argc, VALUE* argv) -> VALUE {\n"
            ...
            "        rb_block_call(attrs, rb_intern(\"each\"), 0, nullptr, RUBY_METHOD_FUNC(static_cast<VALUE(*)(VALUE, VALUE, int, VALUE*)>(key_iterator)), self);\n"
            "    }\n"
            "    return self;\n"
            "}\n"
            "\n"
